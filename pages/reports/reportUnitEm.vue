<template>
    <div>
      <h1 class="my-10">ລາຍງານພະນັກງານຂອງໜ່ວຍງານ (<span class="primary--text"> {{ data?.count }} ຄົນ </span> )</h1>
      <v-row>
        <v-col cols="4">
          <v-text-field
            v-model="search"
  ...
  export default {
    data() {
      return {
        ...
        e_headers: "ລາຍງານພະນັກງານໜ່ວຍງານ",
        title:
          "ລາຍງານພະນັກງານຂອງໜ່ວຍງານ" +
