<template>
    <div>
      ...
      <v-dialog v-model="dialog" max-width="500px" transition="dialog-transition">
        <v-card>
          <v-card-title class="primary white--text">ສ້າງໜ່ວຍງານ</v-card-title>
          <v-divider></v-divider>
      ...
      >
        <v-card>
          <v-card-title class="primary white--text">ອັບເດບໜ່ວຍງານ</v-card-title>
          <v-divider></v-divider>
          <v-card-text class="mt-3">
            <v-text-field
              v-model="mData.title"
